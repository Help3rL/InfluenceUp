...
class TemplateHooks {
	...
	public static function payment_receipt_popup_actions( $order_id ) {
		...
		<div class="action-btn">
			<a href="<?php echo esc_url( Link::get_checkout_endpoint_url( "payment-receipt", $order_id ) ); ?>" class="btn">
			...
			<a href="<?php echo esc_url( Link::get_checkout_endpoint_url( "submission", $listing->get_id() ) ); ?>"
			   class="rtcl-promote-btn rtcl-tooltip-wrapper">
				<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M11.258 1.66016C11.378 1.66016 11.498 1.61438 11.5896 1.52283L12.3123 0.800171C12.4954 0.617187 12.4954 0.320435 12.3123 0.137329C12.1293 -0.0457764 11.8324 -0.0457764 11.6493 0.137329L10.9266 0.859985C10.7436 1.04297 10.7436 1.33972 10.9266 1.52283C11.0182 1.61438 11.1382 1.66016 11.258 1.66016Z" fill="#646464"/>
					<path d="M15.1998 3.6875L14.4771 4.41028C14.294 4.59338 14.294 4.89014 14.4771 5.07324C14.5686 5.16479 14.6885 5.21045 14.8085 5.21045C14.9285 5.21045 15.0485 5.16467 15.14 5.07324L15.8627 4.35046C16.0458 4.16736 16.0458 3.87061 15.8627 3.6875C15.6795 3.50452 15.3828 3.50452 15.1998 3.6875Z" fill="#646464"/>
				</svg>
			...
			<a href="<?php echo esc_url( Link::get_listing_edit_page_link( $listing->get_id() ) ); ?>" class="rtcl-tooltip-wrapper"
			   data-id="<?php echo esc_attr( $listing->get_id() ) ?>">
				<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M5.84802 10.6515C5.71667 10.6515 5.58862 10.5995 5.49463 10.5049C5.37598 10.3869 5.32532 10.2168 5.35803 10.0535L5.82935 7.69597C5.84863 7.59868 5.89661 7.50992 5.96594 7.44058L12.8707 0.536085C13.5853 -0.178695 14.748 -0.178695 15.4634 0.536085C15.8093 0.882061 16 1.34218 16 1.83221C16 2.32224 15.8093 2.78224 15.4626 3.12834L8.55872 10.0336C8.48938 10.1035 8.40002 10.1509 8.30334 10.1702L5.94666 10.6415C5.91394 10.6482 5.88062 10.6515 5.84802 10.6515ZM6.78003 8.04073L6.48596 9.51412L7.95862 9.21941L14.756 2.42162C14.9133 2.26352 15 2.05489 15 1.83221C15 1.60954 14.9133 1.40078 14.756 1.24281C14.432 0.918075 13.9033 0.918075 13.5774 1.24281L6.78003 8.04073Z" fill="#646464"/>
					<path d="M14.1666 4.21839C14.0387 4.21839 13.9106 4.16968 13.8134 4.07165L11.928 2.18551C11.7327 1.99018 11.7327 1.67351 11.928 1.47818C12.1233 1.28285 12.4399 1.28285 12.6354 1.47818L14.5206 3.36432C14.7159 3.55965 14.7159 3.87633 14.5206 4.07165C14.4226 4.16907 14.2947 4.21839 14.1666 4.21839Z" fill="#646464"/>
				</svg>
	...
	public static function edit_account_form_submit_button() {
		...
		<div class="rtcl-form-group">
			<div class="rtcl-field-col">
				<input type="submit" name="submit" class="btn" value="<?php esc_attr_e( 'Update Account', 'classified-listing' ); ?>"/>
			</div>
		</div>
		<?php
	}
	...
	public static function edit_account_form_location_field() {
		...
		<div class="rtcl-form-group">
			<div class="rtcl-field-col" id="rtcl-location-row">
				...
				<select id="rtcl-location" name="location" class="rtcl-select2 rtcl-select rtcl-form-control rtcl-map-field" required>
			...
			<div class="rtcl-field-col<?php echo empty( $sub_locations ) ? ' rtcl-hide' : ''; ?>" id="sub-location-row">
				...
				<select id="rtcl-sub-location" name="sub_location" class="rtcl-select2 rtcl-select rtcl-form-control rtcl-map-field" required>
			...
			<div class="rtcl-field-col<?php echo empty( $sub_sub_locations ) ? ' rtcl-hide' : ''; ?>" id="sub-sub-location-row">
				<label for='rtcl-sub-sub-location' class="rtcl-field-label">
					<?php echo esc_html( $town_text ); ?>
					<span class="require-star">*</span>
				</label>
				<select id="rtcl-sub-sub-location" name="sub_sub_location" class="rtcl-select2 rtcl-select rtcl-form-control rtcl-map-field" required>
					<option value="">--<?php esc_html_e( 'Select location', 'classified-listing' ) ?>--</option>
					<?php
