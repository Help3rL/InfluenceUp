...
class FilterHooks {
	...
	public static function init() {
		...
		add_filter( 'theme_page_templates', array( __CLASS__, 'add_page_templates' ) );
		add_filter( 'wp_insert_post_data', array( __CLASS__, 'register_page_templates' ) );
		add_filter( 'template_include', array( __CLASS__, 'assign_page_template' ), 99 );
