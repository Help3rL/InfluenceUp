...
global $post;
?>
<div class="rtcl-payment-history-wrap rtcl-MyAccount-content-inner">
	<?php
	if ( $rtcl_query->have_posts() ) {
		?>
		<div class="rtcl-payment-table-wrap">
					...
					<?php while ( $rtcl_query->have_posts() ) : $rtcl_query->the_post();
						...
						<tr>
							<td data-heading="<?php esc_attr_e( 'Order ID:', 'classified-listing' ); ?>">
								<?php
								printf( '<a href="#" class="rtcl-payment-popup-link" data-order-id="%s">%s</a>', $order->get_maybe_id(),
									$order->get_maybe_id() )
								?>
							</td>
		...
		<div class="rtcl-popup">
			<div class="rtcl-popup-content">
				<div class="rtcl-popup-header">
					<h5 class="rtcl-popup-title"><?php _e( 'Payment Details', 'classified-listing' ); ?></h5>
