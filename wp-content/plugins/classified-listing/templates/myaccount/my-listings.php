	...
	<?php if ( $rtcl_query->have_posts() ): ?>
		<div class="rtcl-MyAccount-content-inner">
			<table class="rtcl-my-listing-table">
				<thead>
				<tr>
					<th><?php _e( 'Thumbnail', 'classified-listing' ); ?></th>
					<th class="title-cell"><?php _e( 'Title', 'classified-listing' ); ?></th>
					<th class="price-cell list-on-responsive"><?php _e( 'Price', 'classified-listing' ); ?></th>
					<th class="center-cell list-on-responsive"><?php _e( 'Featured', 'classified-listing' ); ?></th>
					<?php if ( class_exists( 'RtclPro' ) ): ?>
						<th class="center-cell list-on-responsive"><?php _e( 'Top', 'classified-listing' ); ?></th>
						<th class="center-cell list-on-responsive"><?php _e( 'BumpUp', 'classified-listing' ); ?></th>
					<?php endif; ?>
					<th class="list-on-responsive"><?php _e( 'Action', 'classified-listing' ); ?></th>
				</tr>
				</thead>
				<tbody>
				<?php while ( $rtcl_query->have_posts() ) : $rtcl_query->the_post();
					...
					<tr>
						...
						<td class="title-cell">
							<div class="rtcl-ad-details">
								...
								<ul class="rtcl-meta">
									<li>
										<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M7.99941 1.60002C4.46479 1.60002 1.59941 4.4654 1.59941 8.00002C1.59941 11.5346 4.46479 14.4 7.99941 14.4C11.534 14.4 14.3994 11.5346 14.3994 8.00002C14.3994 4.4654 11.534 1.60002 7.99941 1.60002ZM0.399414 8.00002C0.399414 3.80266 3.80205 0.400024 7.99941 0.400024C12.1968 0.400024 15.5994 3.80266 15.5994 8.00002C15.5994 12.1974 12.1968 15.6 7.99941 15.6C3.80205 15.6 0.399414 12.1974 0.399414 8.00002ZM7.99941 3.20002C8.33078 3.20002 8.59941 3.46865 8.59941 3.80002V7.6292L11.0677 8.86337C11.3641 9.01156 11.4843 9.37196 11.3361 9.66835C11.1879 9.96474 10.8275 10.0848 10.5311 9.93668L7.73108 8.53668C7.52781 8.43505 7.39941 8.22729 7.39941 8.00002V3.80002C7.39941 3.46865 7.66804 3.20002 7.99941 3.20002Z" fill="currentColor"/>
										</svg>
								...
								<div class="rtcl-listable">
									...
									?>
									<?php if ( $listing->get_status() !== 'pending' && $expiry_date ) { ?>

										<div class="rtcl-listable-item">
											<span class="listable-label"><?php esc_html_e( 'Expires on', 'classified-listing' ); ?></span>
						...
						<td class="price-cell list-on-responsive" data-column="<?php _e( 'Price:', 'classified-listing' ); ?>">
							<?php Functions::print_html( $listing->get_price_html() ); ?>
						</td>
						<td class="center-cell list-on-responsive" data-column="<?php _e( 'Featured:', 'classified-listing' ); ?>">
							<?php
							$svg_html = $listing->is_featured() ? $tick_svg : $cross_svg;
							Functions::print_html( $svg_html, true );
							?>
						</td>
						<?php if ( class_exists( 'RtclPro' ) ): ?>
							<td class="center-cell list-on-responsive" data-column="<?php _e( 'Top:', 'classified-listing' ); ?>">
								<?php
								$svg_html = $is_top ? $tick_svg : $cross_svg;
								Functions::print_html( $svg_html, true );
								?>
							</td>
							<td class="center-cell list-on-responsive" data-column="<?php _e( 'Bump Up:', 'classified-listing' ); ?>">
								<?php
								$svg_html = $is_bump_up ? $tick_svg : $cross_svg;
								Functions::print_html( $svg_html, true );
								?>
							</td>
						<?php endif; ?>
						<td class="list-on-responsive" data-column="<?php _e( 'Action:', 'classified-listing' ); ?>">
