    ...
    class RT_Contact extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                ...
                __('RT Contact Widget', 'cldirectory-core'), // Name
                array('description' => esc_html__('Displays RT Contact Info', 'cldirectory-core'),) // Args
            );
        }
        ...
        public function form($instance) {
            ...
            $defaults = array(
                'title'       => '',
                'address' => radiustheme\CLDirectory\RDTheme::$options['contact_address'],
                'mail' => radiustheme\CLDirectory\RDTheme::$options['contact_email'],
                'phone' => radiustheme\CLDirectory\RDTheme::$options['contact_phone'],
                'website' => radiustheme\CLDirectory\RDTheme::$options['contact_website'],
            );

            $instance = wp_parse_args( (array) $instance, $defaults ); ?>

            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title: ', 'cldirectory-core'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('address'); ?>"><?php esc_html_e('Address: ', 'cldirectory-core'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('mail'); ?>"><?php esc_html_e('Email: ', 'cldirectory-core'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('phone'); ?>"><?php esc_html_e('Phone Number: ', 'cldirectory-core'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('website'); ?>"><?php esc_html_e('Website Address: ', 'cldirectory-core'); ?></label>
