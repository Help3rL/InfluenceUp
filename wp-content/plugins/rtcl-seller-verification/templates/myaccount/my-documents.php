...
?>
<div id="rtcl-documents-content-wrap" class="rtcl-documents-content-wrap">
    <div class="rtcl-documents-content">
        <div id="rtcl-documents-media">
            <div class="form-group">
                <label><?php esc_html_e( "Photo ID", 'rtcl-seller-verification' ); ?></label>
            ...
            <div class="form-group">
                <label><?php esc_html_e( "Other Document", 'rtcl-seller-verification' ); ?></label>
                <div class="rtcl-document-wrap rtcl-other-document-wrap">
                    <div class="rtcl-document rtcl-other-document<?php echo esc_attr( $document_class ); ?>">
                        ...
                        <div class="other-document">
							<?php if ( $user_id && rtcl_seller_verification_get_document_file_name() ): ?>
                                ...
                                <a href="<?php echo esc_url( rtcl_sv_get_pdf_download_file() ); ?>?user_id=<?php echo esc_attr( $user_id ); ?>&__rtcl_wpnonce=<?php echo esc_attr( $nonceId ); ?>"
					...
					<?php if ( ! $verified ): ?>
                        <div class="alert alert-danger mt-2">
							<?php
							printf(
								esc_html__( "Maximum file size %s, only pdf file allowed.", "rtcl-seller-verification" ),
								$max_file_size
							); ?>
                        </div>
					<?php endif; ?>
