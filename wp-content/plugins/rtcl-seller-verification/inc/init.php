	...
	final class RtclSellerVerification {
		...
		public function front_end_script() {
			...
			wp_localize_script( 'rtcl-seller-verification', 'rtcl_seller', apply_filters( 'rtcl_seller_localize', [
				...
				"error_image_size"      => sprintf( esc_html__( "Image size is more then %s.", "rtcl-seller-verification" ), Functions::formatBytes( $max_image_size ) ),
				"error_file_size"       => sprintf( esc_html__( "File size is more then %s.", "rtcl-seller-verification" ), Functions::formatBytes( $max_file_size ) ),
		...
		function load_admin_scripts() {
			...
			wp_enqueue_style( 'rtcl-seller-verification-admin', RTCL_SELLER_URL . '/assets/css/seller-verification-admin.css', [ 'rtcl-public' ], $version );
