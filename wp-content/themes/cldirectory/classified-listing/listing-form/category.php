...
<div class="rtcl-listing-info-selecting cldirectory-listing-form">
	<?php if ( ! Functions::is_ad_type_disabled() ): ?>
        <div id="rtcl-ad-type-selection">
            <div class="rtcl-post-section-title">
                <h3>
                    <i class="rtcl-icon rtcl-icon-tags"></i><?php esc_html_e( "Select a type", "cldirectory" ); ?>
                </h3>
            </div>
            <div class="form-group row">
                <label for="rtcl-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Ad Type', 'cldirectory' ); ?>
                    <span class="require-star">*</span>
                </label>
                <div class="col-md-10">
                    <select class="rtcl-select2 form-control" id="rtcl-ad-type" name="type" required>
                        <option value=""><?php esc_html_e( "--Select a type--", "cldirectory" ) ?></option>
						<?php
    ...
    <div id="rtcl-ad-category-selection"
        ...
        <div class="rtcl-post-section-title">
            <h3>
                <i class="rtcl-icon rtcl-icon-tags"></i><?php esc_html_e( "Select a category", "cldirectory" ); ?>
            </h3>
        </div>
        <div class="rtcl-post-category">
            <div class="form-group row" id="cat-row">
                <label for="rtcl-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Category', 'cldirectory' ); ?>
            ...
            <div class="form-group row<?php echo empty( $child_cats ) ? ' rtcl-hide' : ''; ?>" id="sub-cat-row">
                <label for="rtcl-sub-category"
                       class="col-md-2 col-form-label"><?php esc_html_e( 'Sub Category', 'cldirectory' ); ?>
                    <span class="require-star">*</span></label>
