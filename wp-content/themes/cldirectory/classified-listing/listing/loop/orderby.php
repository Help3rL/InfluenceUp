...
$newvalue                    = [ 'date-desc' => __( 'Recently added (latest)', 'cldirectory' ) ];
$new_catalog_orderby_options = $newvalue + $catalog_orderby_options;
?>

<form class="rtcl-ordering cldirectory-listing-page-filter" method="get">
    <select name="orderby" id="orderby" class="orderby select2" aria-label="<?php esc_attr_e( 'Listing order', 'cldirectory' ); ?>">
