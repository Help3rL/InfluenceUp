    ...
    <div id="rtcl-store-sub-menu" class="rtcl-account-sub-menu">
        <ul>
            <li class="active"><a class="" data-target="settings"
                                  href="#"><?php esc_attr_e( "Settings", "cldirectory" ); ?></a>
            </li>
            <li><a data-target="managers" href="#"><?php esc_html_e("Managers", "clcar"); ?></a></li>
        </ul>
    </div>
<?php endif; ?>
    ...
    <div class="rtcl-store-settings rtcl-store-content" id="rtcl-store-settings-content">
        <div id="rtcl-store-media">
            <div class="form-group">
                <label><?php esc_html_e( "Store Banner", 'cldirectory' ); ?></label>
                <div class="rtcl-store-media-item rtcl-store-banner-wrap">
                    ...
                    <div class="rtcl-store-banner<?php echo esc_attr( $bannerClass ); ?>">
                        <div class="rtcl-media-action">
                            <span class="rtcl-icon-plus add"><?php esc_html_e( "Add Banner", "cldirectory" ) ?></span>
                            <span class="rtcl-icon-trash remove"><?php esc_html_e( "Delete Banner", "cldirectory" ) ?></span>
                        </div>
                    ...
                    <div class="alert alert-danger mt-2">
						...
						printf(
							esc_html__( "Recommended image size to (%dx%d)px, Maximum file size %s, Allowed image type (%s)", "cldirectory" ),
        ...
        <div id="rtcl-store-media">
            <div class="form-group">
                <label><?php esc_html_e( "Store Logo", 'cldirectory' ); ?></label>
                <div class="rtcl-store-media-item rtcl-store-logo-wrap">
                    ...
                    <div class="rtcl-store-logo<?php echo esc_attr( $logoClass ); ?>">
                        <div class="rtcl-media-action">
                            <span class="rtcl-icon-plus add"><?php esc_html_e( "Add Logo", "cldirectory" ) ?></span>
                            <span class="rtcl-icon-trash remove"><?php esc_html_e( "Delete Logo", "cldirectory" ) ?></span>
                        </div>
                    ...
                    <div class="alert alert-danger mt-2">
						...
						printf(
							esc_html__( "Recommended image size to (%dx%d)px, Maximum file size %s, Allowed image types %s", "cldirectory" ),
        ...
        <form id="rtcl-store-settings" class="mt-4 form form-horizontal" method="post" role="form">
            ...
            <div id="rtcl-store-hours">
                <div class="form-group">
                    <label><?php esc_html_e( "Opening hours", "cldirectory" ) ?></label>
                            ...
                            <div id="oh-type-wrap">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label"
                                           for="oh-type-open-on-selected"><?php esc_html_e( "Open on selected hours", "cldirectory" ) ?></label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="meta[oh_type]"
                                    ...
                                    <label class="form-check-label"
                                           for="oh-type-always-open"><?php esc_html_e( "Always open", "cldirectory" ) ?></label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-group row">
                <label for="rtcl-store-name"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Name', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-store-id"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Slug / URL', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
					<?php
                    ...
                    <small class="form-text"><?php esc_html_e( 'This should be unique and you can\'t able to change in future. This will be your store url.', 'cldirectory' ); ?></small>
                </div>
            </div>

            <div class="form-group row">
                <label for="rtcl-slogan"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Slogan', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="rtcl-store-category-wrap">
                <div class="form-group row" id="rtcl-store-cat-row">
                    <label for="rtcl-store-category"
                           class="col-sm-3 col-form-label"><?php esc_html_e( 'Store Category', 'cldirectory' ); ?>
                    </label>
                ...
                <div class="form-group row<?php echo esc_attr($hideRow); ?>" id="rtcl-store-sub-cat-row">
                    <label for="rtcl-store-sub-category"
                           class="col-sm-3 col-form-label"><?php esc_html_e( 'Store Sub Category', 'cldirectory' ); ?>
                    </label>
            ...
            <div class="form-group row">
                <label for="rtcl-email"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store E-mail Address', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-phone"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Phone', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-website"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Website', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-store-address"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Address', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-store-details"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Details', 'cldirectory' ); ?></label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="rtcl-social"
                       class="col-sm-3 control-label"><?php esc_html_e( 'Store Media', 'cldirectory' ); ?></label>
            ...
            <div class="form-group row">
                <div class="offset-sm-3 col-sm-9">
                    <input type="submit" name="submit" class="btn btn-primary"
                           value="<?php esc_html_e( 'Update Store', 'cldirectory' ); ?>"/>
                </div>
            </div>
        </form>
	...
	<?php if ( $store = StoreFunctions::get_current_user_store() ):
        ...
        <div id="rtcl-store-managers-content" class="rtcl-store-content">
            <div class="rtcl-store-manager-action">
                <span class="rtcl-store-invite-manager btn btn-primary"><?php esc_html_e( "Invite Manager", "cldirectory" ); ?></span>
            </div>
				...
				if ( ! empty( $manager_ids ) ) {
					foreach ( $manager_ids as $manager_id ) {
                        ...
                        <div class="rtcl-store-manager">
                            <div class="rtcl-store-m-avatar"><?php wp_kses_post($pp_id ? wp_get_attachment_image( $pp_id, [
                                    100,
                                    100
                            ...
                            <div class="rtcl-store-m-info">
								...
								<?php if ( $isPending ) { ?>
                                    <div class="rtcl-m-info pending"><?php esc_html_e( "Pending", "cldirectory" ); ?></div>
								<?php } else { ?>
                                    <div class="rtcl-m-info">
                                        <a href="<?php echo esc_url( add_query_arg( [ 'manager' => $user->user_login ], Link::get_account_endpoint_url( 'listings' ) ) ) ?>">
											<?php printf( esc_html__( 'Listings (%s)', 'cldirectory' ), count( $store->get_manager_listing_ids( $manager_id ) ) ); ?>
                                        </a>
                                    </div>
								<?php } ?>
                            </div>
