...
namespace radiustheme\CLDirectory\Customizer\Typography;
...
class Customizer_Typography_settings {
	...
	public function register_typography_sections( $wp_customize ) {
		...
		$wp_customize->add_panel( 'rt_typo_panel',
			[
				'title'       => esc_html__( 'Typography', 'cldirectory' ),
				'description' => esc_html__( 'Change site typography.', 'cldirectory' ),
				'priority'    => 15,
			]
		);
		// Body
		$wp_customize->add_section( 'typography_body_section',
			[
				'title'    => esc_html__( 'Body', 'cldirectory' ),
				'priority' => 10,
				'panel'    => 'rt_typo_panel',
			]
		);
		...
		$wp_customize->add_section( 'typography_heading_section',
			[
				'title'    => esc_html__( 'Heading', 'cldirectory' ),
				'priority' => 12,
				'panel'    => 'rt_typo_panel',
			]
		);
		...
		$wp_customize->add_section( 'typography_menu_section',
			[
				'title'    => esc_html__( 'Menu', 'cldirectory' ),
				'priority' => 14,
				'panel'    => 'rt_typo_panel',
			]
		);
	...
	public function register_typography_controls( $wp_customize ) {
		...
		$wp_customize->add_control( 'typo_body_size',
			[
				'label'       => __( 'Font Size', 'cldirectory' ),
				'description' => esc_html__( 'Font Size (px)', 'cldirectory' ),
				'section'     => 'typography_body_section',
				'type'        => 'text',
				'input_attrs' => [
					'class' => 'rtt-txt-box',
		...
		$wp_customize->add_control( 'typo_body_height',
			[
				'label'       => __( 'Line Height', 'cldirectory' ),
				'description' => esc_html__( 'Line Height (px)', 'cldirectory' ),
				'section'     => 'typography_body_section',
				'type'        => 'text',
				'input_attrs' => [
					'class' => 'rtt-txt-box',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_heading',
			[
				'label'       => esc_html__( 'All Heading Typography (H1-H6)', 'cldirectory' ),
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h1',
			[
				'label'       => __( 'Header h1 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h2',
			[
				'label'       => __( 'Header h2 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h3',
			[
				'label'       => __( 'Header h3 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( 'typo_h3_size',
			[
				'label'       => esc_html__( 'Font Size', 'cldirectory' ),
				'description' => esc_html__( 'Font Size (px)', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( 'typo_h3_height',
			[
				'label'       => esc_html__( 'Line Height', 'cldirectory' ),
				'description' => esc_html__( 'Line Height (px)', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h4',
			[
				'label'       => esc_html__( 'Header h4 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h5',
			[
				'label'       => esc_html__( 'Header h5 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h6',
			[
				'label'       => esc_html__( 'Header h6 ', 'cldirectory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_menu',
			[
				'label'       => esc_html__( 'Menu', 'cldirectory' ),
		...
		$wp_customize->add_setting( 'sub_menu_typo',
			[
				'default'           => $this->defaults['sub_menu_typo'],
				'sanitize_callback' => 'rttheme_google_font_sanitization',
			]
		);
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'sub_menu_typo',
			[
				'label'       => esc_html__( 'Submenu', 'cldirectory' ),
				'section'     => 'typography_menu_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( 'typo_submenu_size',
			[
				'label'       => __( 'Sub Menu Font Size', 'cldirectory' ),
				'description' => esc_html__( 'Font Size (px)', 'cldirectory' ),
				'section'     => 'typography_menu_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( 'typo_submenu_height',
			[
				'label'       => __( 'Sub Menu Line Height', 'cldirectory' ),
				'description' => esc_html__( 'Line Height (px)', 'cldirectory' ),
				'section'     => 'typography_menu_section',
				'type'        => 'text',
				'input_attrs' => [
