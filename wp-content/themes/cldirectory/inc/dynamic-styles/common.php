...
$sub_menu_typo = json_decode( RDTheme::$options['sub_menu_typo'], true );
if ( $typo_menu['font'] == 'Inherit' ) {
	$typo_menu = [
		'font'          => 'Nunito',
		'regularweight' => '500',
...
.site-header .main-navigation ul li ul li a {
    font-family: '<?php echo esc_html( $sub_menu_typo['font'] ); ?>', sans serif;
    font-weight : <?php echo esc_html( $sub_menu_typo['regularweight']); ?>;
