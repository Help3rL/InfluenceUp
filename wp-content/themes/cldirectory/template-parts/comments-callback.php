    ...
    <div class="media-body comments-body">
        <div class="comment-meta clearfix">
            <div class="comment-meta-left">
                ...
                <div class="comment-time"><?php printf( esc_html__( ' %1$s ago / %2$s @ %3$s', 'cldirectory' ), $human_time, $date, $time ); ?></div>
            </div>
			<?php
			comment_reply_link(
				array_merge( $args, [
        ...
        <div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
                <p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'cldirectory' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>
        </div>
    </div>
